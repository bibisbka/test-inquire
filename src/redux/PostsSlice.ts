...
import {
  ...
  PostType,
  ResponsePostType,
  ResponseCurrentPost, deletePost, postNewPost, updatePost, postNewComment
} from "../api/api";
...
export const postsSlice = createSlice({
  ...
  reducers: {
    setNewPostTitle: (state, {payload}: PayloadAction<string>) => ({
      ...state,
      newPost: {
        ...state.newPost,
        title: payload
    ...
    setNewPostBody: (state, {payload}: PayloadAction<string>) => ({
      ...state,
      newPost: {
        ...state.newPost,
        body: payload
